  ...
  > {
    return .init { state, action, environment in
      guard state != nil else {
        assertionFailure(
          """
          "\(action)" was received by an optional reducer when its state was \
  ...
  public func forEach<GlobalState, GlobalAction, GlobalEnvironment>(
    ...
    return .init { globalState, globalAction, globalEnvironment in
      ...
      assert(
        ...
        """
        "\(localAction)" was received by a "forEach" reducer at index \(index) \
  ...
  public func forEach<GlobalState, GlobalAction, GlobalEnvironment, Key>(
    ...
    return .init { globalState, globalAction, globalEnvironment in
      ...
      assert(
        ...
        """
        "\(localAction)" was received by a "forEach" reducer at key \(key) \
